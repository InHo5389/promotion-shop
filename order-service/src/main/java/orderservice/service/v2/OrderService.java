...
public class OrderService {
    ...
    public OrderResponse order(OrderRequest request) {
        ...
        eventPublisher.publishEvent(EventType.STOCK_DECREASE, stockPayload, EventType.Topic.PRODUCT_STOCK_DECREASE);
        ...
        if (request.getCouponInfo() != null && request.getCouponInfo().getCouponId() != null) {
            ...
            eventPublisher.publishEvent(EventType.COUPON_APPLIED, couponPayload, EventType.Topic.COUPON_APPLIED);
        ...
        if (request.getPoint() != null && request.getPoint() > 0) {
            ...
            eventPublisher.publishEvent(EventType.POINT_USED, pointPayload, EventType.Topic.POINT_USED);
        ...
        eventPublisher.publishEvent(EventType.ORDER_CREATED, orderPayload, EventType.Topic.ORDER);
    ...
    public OrderResponse cancel(Long orderId, Long userId) {
        ...
        StockIncreasedEventPayload stockPayload = StockIncreasedEventPayload.builder()
                ...
                .items(order.getOrderItems().stream()
                        ...
                        .collect(Collectors.toList()))
                .build();
        eventPublisher.publishEvent(EventType.STOCK_INCREASE, stockPayload, EventType.Topic.PRODUCT_STOCK_INCREASE);
        ...
        CouponCanceledEventPayload couponPayload = CouponCanceledEventPayload.builder()
                ...
                .build();
        eventPublisher.publishEvent(EventType.COUPON_CANCELED, couponPayload, EventType.Topic.COUPON_CANCELED);
        ...
        if (order.hasPointsUsed()) {
            ...
            eventPublisher.publishEvent(EventType.POINT_CANCELED, pointPayload, EventType.Topic.POINT_CANCELED);
    ...
    public OrderResponse cartOrder(CartOrderRequest request) {
        ...
        eventPublisher.publishEvent(EventType.CART_CLEARED, cartPayload, EventType.Topic.CART);
