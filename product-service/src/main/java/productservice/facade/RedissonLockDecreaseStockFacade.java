...
//public class RedissonLockDecreaseStockFacade {
//
...
//            decreaseStockForSingleOption(request);
//        }
//    }
//
//    private void decreaseStockForSingleOption(ProductOptionRequest.StockUpdate request) {
//        // 락 키 생성
//        String lockKey = LOCK_KEY_PREFIX + request.getOptionId();
//        RLock lock = redissonClient.getLock(lockKey);
//
//        try {
//            // 5초 동안 락 획득 시도, 획득 시 3초 동안 락 유지
